...
function vocab = build_vocabulary_sift_fisher( image_paths, vocab_size )
...
% visual word vocabulary.
    ...
    for id=1:N
        ...
        D(:,sample * (id - 1) + 1 :sample * id) = SIFT_features(:,1:sample);
    end

    [means, covariances, priors] = vl_gmm(D, vocab_size);
    vocab = {means, covariances, priors};
end
